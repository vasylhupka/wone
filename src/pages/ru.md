  ...
  - type: features_section
    features:
      - title: >-
        ...
        subtitle: "1. Возможность дополнительного заработка без необходимости выполнения конкретных задач.\_ \n 2. Не предусматривает дополнительных расходов.\_ \n 3. Чуткий интерфейс.\_ \n Вы можете одновременно использовать несколько приложений для увеличения заработка" 
