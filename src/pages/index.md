...
sections:
  - type: hero_section
    ...
    subtitle: "Ви можете використовувати додаток Honeygain,\_якщо не проти поділитися своїми інтернетом у фоновому режимі вашого пристрою. Ви навіть не помічатитмете, що Honeygain працює.\_Встановіть програму honeygain на свій пристрій Android або Windows."
    actions:
