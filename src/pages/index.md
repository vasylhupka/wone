  ...
  - type: features_section
    ...
    features:
      ...
      - title: Включені плагіни Premium
        content: "Двадцять дев'ять найпопулярніших та найпотужніших плагінів преміум-класу на суму $ 701 включені до теми Deep.\_Все готово;\_почати!\_Ви знайдете список доступних плагінів теми наступним чином:\n\n*   WPBakery Page Builder \n\n*   King Composer Pro \n\n*   Slider Revolution \n\n*   Element Pack for Elementor\n\n*   WordPress GDPR \n\n*   Ultimate Add-ons\n\nThe Grid The Grid LayerSlider LayerSlider ModuloBox LightBox Plugin ModuloBox LightBox Plugin Easy Social Share Buttons Easy Social Share Buttons Yellow Pencil Yellow Pencil Ninja Popups Ninja Popups ACF Pro ACF Pro Real Media Library Real Media Library Go Pricing Go Pricing Material White Label Material White Label Opt-In Panda Opt-In Panda Quform Quform JetElements JetElements JetMenu JetMenu JetBlog JetBlog JetTabs JetTabs JetReviews JetReviews JetWooBiulder JetWooBiulder JetBlocks JetBlocks JetEngine JetEngine JetTricks JetTricks JetPopup JetPopup WP Domain Checker WP Domain Checker\n"
        actions:
          - label: Learn More
            url: /thank-you
            style: link
