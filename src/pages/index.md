...
sections:
  - type: hero_section
    ...
    subtitle: "Якщо ви не проти поділитися своїми даними з додатком у фоновому режимі вашого пристрою, ви навіть не повинні помітити, що Honeygain працює.\_Встановіть програму honeygain на свій пристрій Android або Windows."
    actions:
      - label: Більше
